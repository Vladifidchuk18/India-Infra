...
Author: Will Schroeder (@VladiFidchuk)  
License: BSD 3-Clause  
Required Dependencies: None  
...
BowerUb.TokenPrivilege.ModifiablePath
...
#>
    ...
    [OutputType('BowerUb.ModifiablePath')]
    [CmdletBinding()]
    Param(
                ...
                Get-Acl -Path $CandidatePath | Select-Object -ExpandProperty Access | Where-Object {($_.AccessControlType -match 'Allow')} | ForEach-Object {
                    ...
                    if ($Comparison) {
                        ...
                        if ($CurrentUserSids -contains $IdentitySID) {
                            ...
                            $Out.PSObject.TypeNames.Insert(0, 'BowerUb.ModifiablePath')
                            $Out
                        }
                    }
                }
...
#>
    ...
    [OutputType('BowerUb.TokenGroup')]
    [OutputType('BowerUb.TokenPrivilege')]
    [CmdletBinding()]
    Param(
                ...
                For ($i=0; $i -lt $TokenGroups.GroupCount; $i++) {
                    ...
                    if ($TokenGroups.Groups[$i].SID) {
                        ...
                        if ($Result -eq 0) {
                            ...
                            $GroupSid.PSObject.TypeNames.Insert(0, 'BowerUb.TokenGroup')
                            $GroupSid
                        }
                    }
                }
        ...
        elseif ($InformationClass -eq 'Privileges') {
            ...
            if ($Success) {
                ...
                For ($i=0; $i -lt $TokenPrivileges.PrivilegeCount; $i++) {
                    ...
                    $Privilege.PSObject.TypeNames.Insert(0, 'BowerUb.TokenPrivilege')
                    $Privilege
                }
            }
            else {
            ...
            if ($Success2) {
                ...
                $TokenResult.PSObject.TypeNames.Insert(0, 'BowerUb.TokenType')
                $TokenResult
            }
            else {
                Write-Warning ([ComponentModel.Win32Exception] $LastError)
...
Author: Will Schroeder (@VladiFidchuk), Matthew Graeber (@mattifestation)  
License: BSD 3-Clause  
Required Dependencies: PSReflect  
...
#>
    ...
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [OutputType('BowerUb.UnquotedService')]
    [CmdletBinding()]
    Param()
    ...
    if ($VulnServices) {
        ForEach ($Service in $VulnServices) {
            ...
            $ModifiableFiles | Where-Object {$_ -and $_.ModifiablePath -and ($_.ModifiablePath -ne '')} | Foreach-Object {
                ...
                $Out.PSObject.TypeNames.Insert(0, 'BowerUb.UnquotedService')
                $Out
            }
        }
    }
...
BowerUb.ModifiablePath
#>

    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [OutputType('BowerUb.ModifiableServiceFile')]
    [CmdletBinding()]
    Param()
    ...
    Get-WMIObject -Class win32_service | Where-Object {$_ -and $_.pathname} | ForEach-Object {
        ...
        $ServicePath | Get-ModifiablePath | ForEach-Object {
            ...
            $Out | Add-Member Noteproperty 'CanRestart' ([Bool]$CanRestart)
            $Out | Add-Member Aliasproperty Name ServiceName
            $Out.PSObject.TypeNames.Insert(0, 'BowerUb.ModifiableServiceFile')
            $Out
        }
    }
}
...
#>
    ...
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [OutputType('BowerUb.ModifiableService')]
    [CmdletBinding()]
    Param()
    ...
    Get-Service | Test-ServiceDaclPermission -PermissionSet 'ChangeConfig' | ForEach-Object {
        ...
        $Out | Add-Member Noteproperty 'CanRestart' ([Bool]$CanRestart)
        $Out | Add-Member Aliasproperty Name ServiceName
        $Out.PSObject.TypeNames.Insert(0, 'BowerUb.ModifiableService')
        $Out
    }
}
...
BowerUb.AbusedService
#>

    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidUsingUserNameAndPassWordParams', '')]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidUsingPlainTextForPassword', '')]
    [OutputType('BowerUb.AbusedService')]
    [CmdletBinding()]
    Param(
        [Parameter(Position = 0, Mandatory = $True, ValueFromPipeline = $True, ValueFromPipelineByPropertyName = $True)]
        [Alias('ServiceName')]
    ...
    PROCESS {
        ...
        ForEach($IndividualService in $Name) {
            ...
            $Out.PSObject.TypeNames.Insert(0, 'BowerUb.AbusedService')
            $Out
        }
    }
}
...
BowerUb.ServiceBinary
#>

    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidUsingUserNameAndPassWordParams', '')]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidUsingPlainTextForPassword', '')]
    [OutputType('BowerUb.ServiceBinary')]
    [CmdletBinding()]
    Param(
        [Parameter(Position = 0, Mandatory = $True, ValueFromPipeline = $True, ValueFromPipelineByPropertyName = $True)]
        [Alias('ServiceName')]
    ...
    PROCESS {
        ...
        $Out.PSObject.TypeNames.Insert(0, 'BowerUb.ServiceBinary')
        $Out
    }
}
...
BowerUb.ServiceBinary.Installed
#>

    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidUsingUserNameAndPassWordParams', '')]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidUsingPlainTextForPassword', '')]
    [OutputType('BowerUb.ServiceBinary.Installed')]
    [CmdletBinding()]
    Param(
        [Parameter(Position = 0, Mandatory = $True, ValueFromPipeline = $True, ValueFromPipelineByPropertyName = $True)]
        [Alias('ServiceName')]
    ...
    PROCESS {
        ...
        $Result.PSObject.TypeNames.Insert(0, 'BowerUb.ServiceBinary.Installed')
        $Result
    }
}
...
#>
    ...
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [OutputType('BowerUb.ServiceBinary.Restored')]
    [CmdletBinding()]
    Param(
        [Parameter(Position = 0, Mandatory = $True, ValueFromPipeline = $True, ValueFromPipelineByPropertyName = $True)]
        [Alias('ServiceName')]
    ...
    PROCESS {
        ...
        $Out.PSObject.TypeNames.Insert(0, 'BowerUb.ServiceBinary.Restored')
        $Out
    }
}
...
#>
    ...
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [OutputType('BowerUb.HijackableDLL.Process')]
    [CmdletBinding()]
    Param(
        [Parameter(Position = 0, ValueFromPipeline = $True, ValueFromPipelineByPropertyName = $True)]
        [Alias('ProcessName')]
                    ...
                    ForEach ($Module in $LoadedModules){
                        ...
                        if ((-not $ModulePath.Contains('C:\Windows\System32')) -and (-not (Test-Path -Path $ModulePath)) -and ($KnownDLLs -NotContains $Module.ModuleName)) {
                            ...
                            if (-not $Exclude){
                                ...
                                $Out.PSObject.TypeNames.Insert(0, 'BowerUb.HijackableDLL.Process')
                                $Out
                            }
                        }
                    }
...
#>
    ...
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [OutputType('BowerUb.HijackableDLL.Path')]
    [CmdletBinding()]
    Param()
    ...
    Get-Item Env:Path | Select-Object -ExpandProperty Value | ForEach-Object { $_.split(';') } | Where-Object {$_ -and ($_ -ne '')} | ForEach-Object {
        ...
        ForEach ($ModifidablePath in $ModifidablePaths) {
            if ($Null -ne $ModifidablePath.ModifiablePath) {
                ...
                $ModifidablePath.PSObject.TypeNames.Insert(0, 'BowerUb.HijackableDLL.Path')
                $ModifidablePath
            }
        }
    }
...
The Architecture to generate for the DLL, x86 or x64. If not specified, BowerUb
...
BowerUb.HijackableDLL
#>

    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidUsingUserNameAndPassWordParams', '')]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidUsingPlainTextForPassword', '')]
    [OutputType('BowerUb.HijackableDLL')]
    [CmdletBinding()]
    Param(
        [Parameter(Mandatory = $True)]
        [String]
    ...
    $Out.PSObject.TypeNames.Insert(0, 'BowerUb.HijackableDLL')
    $Out
}
...
#>
    ...
    [OutputType('BowerUb.RegistryAutoLogon')]
    [CmdletBinding()]
    Param()
    ...
    if ($AutoAdminLogon -and ($AutoAdminLogon.AutoAdminLogon -ne 0)) {
        ...
        if ($DefaultUserName -or $AltDefaultUserName) {
            ...
            $Out.PSObject.TypeNames.Insert(0, 'BowerUb.RegistryAutoLogon')
            $Out
        }
    }
}
...
BowerUb.ModifiableRegistryAutoRun

Custom PSObject containing results.
#>

    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [OutputType('BowerUb.ModifiableRegistryAutoRun')]
    [CmdletBinding()]
    Param()
    ...
    $SearchLocations | Where-Object { Test-Path $_ } | ForEach-Object {
        ...
        ForEach ($Name in $Keys.GetValueNames()) {
            ...
            $Path | Get-ModifiablePath | ForEach-Object {
                ...
                $Out.PSObject.TypeNames.Insert(0, 'BowerUb.ModifiableRegistryAutoRun')
                $Out
            }
        }
    }
...
BowerUb.ModifiableScheduledTaskFile

Custom PSObject containing results.
#>

    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [OutputType('BowerUb.ModifiableScheduledTaskFile')]
    [CmdletBinding()]
    Param()
        ...
        try {
            ...
            if ($TaskXML.Task.Triggers) {
                ...
                $TaskXML.Task.Actions.Exec.Command | Get-ModifiablePath | ForEach-Object {
                    ...
                    $Out.PSObject.TypeNames.Insert(0, 'BowerUb.ModifiableScheduledTaskFile')
                    $Out
                }
...
BowerUb.UnattendedInstallFile

Custom PSObject containing results.
#>

    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [OutputType('BowerUb.UnattendedInstallFile')]
    [CmdletBinding()]
    Param()
    ...
    $SearchLocations | Where-Object { Test-Path $_ } | ForEach-Object {
        ...
        $Out.PSObject.TypeNames.Insert(0, 'BowerUb.UnattendedInstallFile')
        $Out
    }
...
#>
    ...
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSShouldProcess', '')]
    [OutputType('BowerUb.SiteListPassword')]
    [CmdletBinding()]
    Param(
                ...
                if ($SiteListXml.InnerXml -Like "*password*") {
                    ...
                    $SiteListXml.SiteLists.SiteList.ChildNodes | Foreach-Object {
                        try {
                            ...
                            $Out.PSObject.TypeNames.Insert(0, 'BowerUb.SiteListPassword')
                            $Out
                        }
                        catch {
...
https://github.com/mattifestation/BowerSb/blob/master/Recon/Get-GPPPassword.ps1
...
#>
    ...
    try {
        ...
        $Out.PSObject.TypeNames.Insert(0, 'BowerUb.UserAddMSI')
        $Out
    }
    catch {
...
#>
    ...
    if ($Format -eq 'HTML') {
        ...
        $Header = $Header + "</style>"
        ConvertTo-HTML -Head $Header -Body "<H1>BowerUb report for '$($Env:ComputerName).$($Env:UserName)'</H1>" | Out-File $HtmlReportFile
    }
...
$Module = New-InMemoryModule -ModuleName BowerUbModule
...
# https://rohnspowershellblog.wordpress.com/2013/03/19/viewing-service-acls/
$ServiceAccessRights = psenum $Module BowerUb.ServiceAccessRights UInt32 @{
...
$SidAttributes = psenum $Module BowerUb.SidAttributes UInt32 @{
...
$LuidAttributes = psenum $Module BowerUb.LuidAttributes UInt32 @{
    DISABLED                            =   '0x00000000'
...
$SecurityEntity = psenum $Module BowerUb.SecurityEntity UInt32 @{
...
$SID_AND_ATTRIBUTES = struct $Module BowerUb.SidAndAttributes @{
    Sid         =   field 0 IntPtr
    Attributes  =   field 1 UInt32
}

$TOKEN_TYPE_ENUM = psenum $Module BowerUb.TokenTypeEnum UInt32 @{
    Primary         = 1
    Impersonation   = 2
}

$TOKEN_TYPE = struct $Module BowerUb.TokenType @{
    Type  = field 0 $TOKEN_TYPE_ENUM
}

$SECURITY_IMPERSONATION_LEVEL_ENUM = psenum $Module BowerUb.ImpersonationLevelEnum UInt32 @{
    Anonymous         =   0
    Identification    =   1
    Impersonation     =   2
    Delegation        =   3
...
$IMPERSONATION_LEVEL = struct $Module BowerUb.ImpersonationLevel @{
    ImpersonationLevel  = field 0 $SECURITY_IMPERSONATION_LEVEL_ENUM
}

$TOKEN_GROUPS = struct $Module BowerUb.TokenGroups @{
    GroupCount  = field 0 UInt32
    Groups      = field 1 $SID_AND_ATTRIBUTES.MakeArrayType() -MarshalAs @('ByValArray', 32)
}

$LUID = struct $Module BowerUb.Luid @{
    LowPart         =   field 0 $SecurityEntity
    HighPart        =   field 1 Int32
}

$LUID_AND_ATTRIBUTES = struct $Module BowerUb.LuidAndAttributes @{
    Luid         =   field 0 $LUID
    Attributes   =   field 1 UInt32
}

$TOKEN_PRIVILEGES = struct $Module BowerUb.TokenPrivileges @{
    PrivilegeCount  = field 0 UInt32
    Privileges      = field 1 $LUID_AND_ATTRIBUTES.MakeArrayType() -MarshalAs @('ByValArray', 50)
}

$Types = $FunctionDefinitions | Add-Win32Type -Module $Module -Namespace 'BowerUb.NativeMethods'
