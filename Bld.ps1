...
<#
    .SYNOPSIS
        ...
        This is used for user session deconfliction in the Export-BldJnt* functions for
...
function Invoke-BldJnt {
<#
    .SYNOPSIS

        This function automates the collection of the data needed for BldJnt.
    ...
    .DESCRIPTION
        ...
        This function collects the information needed to populate the BldJnt graph
        ...
        By default, the data is output to CSVs in the current folder location (old Export-BldJntCSV functionality).
    ...
    .PARAMETER URI
        ...
        The BldJnt neo4j URL location (http://host:port/).

    .PARAMETER UserPass

        The "user:password" for the BldJnt neo4j instance
   ...
   .PARAMETER GlobalCatalog
    ...
    .EXAMPLE
        ...
        PS C:\> Invoke-BldJnt -URI http://SERVER:7474/ -UserPass "user:pass"

        Executes default collection options and exports the data to a BldJnt neo4j RESTful API endpoint.

    .EXAMPLE

        PS C:\> Invoke-BldJnt -CollectionMethod stealth
...
#>
    ...
    BEGIN {
        ...
        if ($PSCmdlet.ParameterSetName -eq 'CSVExport') {
            ...
            # check auth to the BldJnt neo4j server
            try {
                ...
                $ObjectSearcher.FindAll() | ForEach-Object {
                    ...
                    if (@('268435456','268435457','536870912','536870913') -contains $Properties['samaccounttype']) {
                        ...
                        if ($MemberName -Match "\\") {
                            ...
                            #   TODO: later preserve this once BldJnt can properly display these characters
...
Set-Alias Get-BldJntData Invoke-BldJnt
